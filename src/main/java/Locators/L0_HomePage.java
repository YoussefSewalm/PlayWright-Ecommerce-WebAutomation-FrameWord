...
public class L0_HomePage {
	...
	public static String LoginSignUpLink = "//ul[@class='nav navbar-nav']//descendant::a[@href='/login']";
	public static String ContactUsLink = "//ul[@class='nav navbar-nav']//descendant::a[@href='/contact_us']";
